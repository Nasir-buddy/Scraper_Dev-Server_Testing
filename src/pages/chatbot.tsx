...
export default function Home() {
    ...
    const handleSubmit = async (e: any) => { // Change to async function
        ...
        setMessages(prevMessages => [
            ...prevMessages,
            { role: "assistant", content: "" } // Placeholder for the assistant response
        ]);
        ...
        while (!done) {
            ...
            if (value) {
                ...
                currentResponse += chunk; // Accumulate the chunk
                ...
                setMessages(prevMessages => {
                    ...
                    if (lastMessage && lastMessage.role === "assistant") {
                        return [
                            ...prevMessages.slice(0, lastMessageIndex), // Keep all previous messages
                            { ...lastMessage, content: currentResponse } // Update the last message
                        ];
                    }
                    return prevMessages; // Fallback if no last message
                });
            }
        }
                    ...
                    <Flex direction="column" gap="4" className="w-full">
                        ...
                        {messages.map((msg, index) => (
                            <div className="mb-2 w-full" key={index}>
                                ...
                                {msg.role === "assistant" && <div className="p-2 rounded mt-2">{<Markdown components={{
