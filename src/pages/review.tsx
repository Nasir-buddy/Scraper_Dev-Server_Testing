...
const ReviewExperience = ({
  ...
  }, [initialLayout, styles, quizzes, currentQuizIndex]);

  useEffect(() => {
    sendMessageToIframe();
  }, [sendMessageToIframe, currentQuizIndex]);
...
const ModeSelector = React.memo(({ mode, setMode }: ModeSelectorProps) => (
...
const DeviceSelector = React.memo(({
  screen,
  setScreen,
  setCustomScreenSize,
  setCurrentQuizIndex,
