// import { ArrowBottomRightIcon, ArrowTopRightIcon, CheckIcon, ExclamationTriangleIcon, MagnifyingGlassIcon } from '@radix-ui/react-icons';
// import { Box, DropdownMenu, Flex, Link, Text } from '@radix-ui/themes';
...
//                     <Box className="lg:w-3/4 w-full py-3 px-5 bg-[#101211] rounded-lg h-[100px]">
...
//                     </Box>
//                 </Box>
//                 <Box className="rounded-lg w-full m-3 py-3 px-5 bg-[#101211]">
//                     <Box className="flex flex-col lg:flex-row justify-between items-center mb-6">
//                         <Text className="text-2xl mb-4 lg:mb-0">Active Quizzes</Text>
//                         <Flex align="center" gap="4">
//                             <Box className="relative w-full lg:w-auto">
        ...
        <Box className="bg-black text-gray-100 pt-6 mt-10">
            <Box className="flex flex-col gap-6">
                ...
                <Flex direction="row" gap="4">
                    ...
                    <Box className="lg:w-3/4 rounded-lg w-full py-3 px-5 bg-[#101211]">
                        <AlertComponent />
                    </Box>
                </Flex>
                {/* Main Content Section */}
                <Box className=" w-full py-3 px-5 bg-[#101211]">
                    <Box className="flex flex-col lg:flex-row justify-between items-center mb-6">
                        <Text className="text-2xl mb-4 lg:mb-0">Active Quizzes</Text>
                        <Flex align="center" gap="4">
                            <Box className="relative w-full lg:w-auto">
