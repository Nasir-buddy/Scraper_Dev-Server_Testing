...
const Editor = ({
  ...
  const handleImageUploadForQuiz = async (
    event: React.ChangeEvent<HTMLInputElement>,
    index: number
  ) => {
    const imageUrl = await handleImageUpload(event);
    if (imageUrl) {
      handleInputChange(index, imageUrl, "image");
    } else {
      console.error("Image upload failed");
    }
  };
        ...
        <Flex direction="column" className="bg-[#141414] text-white p-4 h-full">
          <Flex direction="column" gap="2">
            ...
            {demoQuiz[currentQuizIndex].quizType === "Start Screen" ? (
              ...
              <Flex className="w-full">
                <Button
                  onClick={() => setToggleSelectionLayout(!toggleSelectionLayout)}
                ...
                >
                  ...
                  <Flex align="center" justify="center" className="w-8 h-8 bg-black rounded-full">
                    {toggleSelectionLayout ? (
                      <ArrowUpIcon className="w-4 h-4 text-[#3EC4A1]" />
                    ) : (
                      <ArrowDownIcon className="w-4 h-4 text-[#818181]" />
            ...
            {toggleSelectionLayout && SelectionLayout.includes(demoQuiz[currentQuizIndex].quizType) && (
                          ...
                          {demoQuiz[currentQuizIndex]?.quizType ===
                            ...
                            <Flex align="center" justify="center" width="40%">
                              ...
                              <input
                                ...
                                className="hidden"
                                onChange={(event) =>
                                  handleImageUploadForQuiz(event, index)
                                }
                              />
                            </Flex>
                          )}
            ...
            {toggleStartScreenQuestionLayout && demoQuiz[currentQuizIndex].quizType === "Start Screen" && (
              <Flex direction="column" gap="3">
                <Heading as="h2" size="2">
                  HEADLINE
                </Heading>
                <TextArea
                  ...
                  onChange={(e) => setStartScreenLayoutInput((prev) => ({ ...prev, question: e.target.value }))}
                ...
                <TextArea
                  ...
                  onChange={(e) => setStartScreenLayoutInput((prev) => ({ ...prev, subHeadline: e.target.value }))}
                ...
                <TextArea
                  ...
                  onChange={(e) => setStartScreenLayoutInput((prev) => ({ ...prev, buttonText: e.target.value }))}
                  placeholder="Edit button text"
                  className="h-20 rounded-xl"
                />
                <Flex justify="between">
                  <Button className="rounded-xl w-[40%] bg-[#242424]" color="gray" onClick={() => setToggleSelectionLayout(!toggleSelectionLayout)}>
                    Cancel
                  </Button>
                  <Button className="rounded-xl w-[40%]" onClick={() => updateCurrentQuizItem(startScreenLayoutInput)}>
                    Save
                  </Button>
                </Flex>
              </Flex>
            ...
            <Flex direction="column" gap="3">
              ...
              <Flex justify="between" align="center">
                ...
                <Flex align="center">
                  <input
                    ...
                    onChange={(e) => updateStyleSetting("cornerRadius", e.target.value)}
              ...
              <Flex justify="between" align="center">
                ...
                <Flex align="center">
                  <input
                    ...
                    onChange={(e) => updateStyleSetting("borderWidth", e.target.value)}
                    className="bg-[#242424] w-12 h-8 rounded-lg p-2"
                  />
                  <Box as="span" className="text-white ml-2">
                    px
              ...
              <Flex justify="between" align="center">
                ...
                <input
                  ...
                  onChange={(e) => updateStyleSetting("backgroundButton", e.target.value)}
                  className="w-8 h-8 rounded-lg"
                />
              </Flex>
              <Flex justify="between" align="center">
            ...
            <Flex direction="column" gap="3">
              ...
              <Flex justify="between" align="center" mb="2">
                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger>
                    <Button className="bg-[#242424] text-white flex justify-between p-2" size="1">
                      <Flex gap="1">{styleSettings.font}</Flex>
                      <DropdownMenu.TriggerIcon />
                    </Button>
                  </DropdownMenu.Trigger>
                  <DropdownMenu.Content size="1">
                    <DropdownMenu.Item onSelect={() => updateStyleSetting("font", "Fredoka")}>
                      Fredoka
                    </DropdownMenu.Item>
                    <DropdownMenu.Separator />
                    <DropdownMenu.Item onSelect={() => updateStyleSetting("font", "serif")}>
                      serif
                    </DropdownMenu.Item>
                    <DropdownMenu.Separator />
                    <DropdownMenu.Item onSelect={() => updateStyleSetting("font", "sans")}>
                      sans
                    </DropdownMenu.Item>
                    <DropdownMenu.Separator />
                    <DropdownMenu.Item onSelect={() => updateStyleSetting("font", "mono")}>
                      mono
                    </DropdownMenu.Item>
                    <DropdownMenu.Separator />
                    <DropdownMenu.Item onSelect={() => updateStyleSetting("font", "thin")}>
                      thin
                    </DropdownMenu.Item>
                  </DropdownMenu.Content>
                </DropdownMenu.Root>
              ...
              <Flex justify="between" align="center">
                ...
                <input
                  ...
                  onChange={(e) => updateStyleSetting("textColor", e.target.value)}
                  className="w-8 h-8 rounded-lg"
                />
              </Flex>
              <Flex justify="between" align="center">
                ...
                <Flex align="center">
                  <input
                    ...
                    onChange={(e) => updateStyleSetting("lineHeight", e.target.value)}
                    className="bg-[#242424] w-12 h-8 rounded-lg p-2"
                  />
                  <Box as="span" className="text-white ml-2">
                    px
              ...
              <Flex justify="between" align="center">
                ...
                <Flex align="center">
                  <input
                    ...
                    onChange={(e) => updateStyleSetting("letterSpacing", e.target.value)}
                    className="bg-[#242424] w-12 h-8 rounded-lg p-2"
                  />
                  <Box as="span" className="text-white ml-2">
                    px
              ...
              <Flex justify="between" align="center">
                ...
                <Flex align="center">
                  <input
                    ...
                    onChange={(e) => updateStyleSetting("boldness", e.target.value)}
                    className="bg-[#242424] w-12 h-8 rounded-lg p-2"
                    min="1"
                    max="9"
                  />
