...
const Home = dynamic(() => import("./home/HomeComponent"), { suspense: true });
const VerticalNav = dynamic(() => import("./components/VerticalNav"), { suspense: true });

export interface BasicInfoProps {
  quizzes: QuizFormDataType[];
}

const Platform: React.FC<BasicInfoProps> = ({ quizzes }) => {
  return (
